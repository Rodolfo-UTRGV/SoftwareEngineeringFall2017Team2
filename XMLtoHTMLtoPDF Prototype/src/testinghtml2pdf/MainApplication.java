...
public class MainApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // input files:
        String xmlFile  = "nutritionXml.xml";
        String xslFile  = "nutritionXsl.xsl";
       
        // Output Files
        String htmlFile = "NutritionHtml.htm";
        String pdfFile  = "Nutrition.pdf";
        ...
        // Testing combine xml files into another xml
          ...
          //list is hard coded...
          list.add("nutritionXml.xml");
          list.add("nutritionXml.xml");
          //mergeMultipleXMLDocs(list of files,root node, output file);
          mergeMultipleXMLDocs(list,"Foods", "AlinOne.xml");
